...
{
	public partial class NextLevelEntity : PositionedObject, IDestroyable
	{
        ...
        public NextLevelEntity(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public NextLevelEntity(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("NextLevelEntityStaticUnload", UnloadStaticContent);
